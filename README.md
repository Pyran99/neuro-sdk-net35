<!-- This fork is a slight modification intended for use with older .Net 3.5 C# projects. (<TargetFramework>net35</TargetFramework>) -->
...
2. Add the packages from NuGet (https://www.nuget.org/packages/WebSocketSharp/) (https://www.nuget.org/packages/TaskParallelLibrary) (https://www.nuget.org/packages/Newtonsoft.Json/12.0.3)
3. Copy the contents of <folder> into your project
